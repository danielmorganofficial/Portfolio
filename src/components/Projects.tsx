    ...
    <section className="mt-20">
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-2">
        {projects.map((project, idx) => {
          ...
          const Wrapper: any = isLink ? motion.a : motion.article;
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 flex w-full items-center justify-between gap-3">
                ...
                <span className={`flex h-10 w-10 items-center justify-center rounded-full bg-white/[0.05] text-white transition-all ${isLink ? 'group-hover:bg-cyan-500 group-hover:text-slate-950' : ''}`}>
                  {isLink ? (
